...
def load_cache(cache_name, keys):
    """Load cached data from a saved file.

    Parameters
    ----------
        cache_name: str
                    The filepath to the cache file
        keys: list
              A list of keys to fetch in the cache (list of str)
...
def save_cache(cache_name, d):
    """Save data in a compressed file

    Parameters
    ----------
        cache_name: str
                    The filepath of the cache file to save
        d: dict
           A dictionnary with keys the variable names and values the values
