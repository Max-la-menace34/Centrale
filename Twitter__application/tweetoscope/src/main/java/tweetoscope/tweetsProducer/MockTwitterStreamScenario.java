...
public final class MockTwitterStreamScenario extends OfflineTweetsProducer {
	...
	/**
	 * Crafts a predefined set of Tweets.
	 * 
	 * @return Tweet[] array.
	 */
	 ...
	 * Crafts a predefined set of Tweets.
	 * 
	 * @return TweetMapper[] array.
	 */
	protected TweetMapper[] getTweetMappers() {
		Tweet[] tweets = getTweets();
		TweetMapper[] tweetMappers = new TweetMapper[tweets.length];
		for (int i=0; i<tweets.length; i++) {
			tweetMappers[i] = new TweetMapper(tweets[i]);
		}
