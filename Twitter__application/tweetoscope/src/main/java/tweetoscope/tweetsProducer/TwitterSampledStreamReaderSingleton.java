...
public final class TwitterSampledStreamReaderSingleton extends OnlineTweetsProducer {
	 ...
	 */
	private TwitterSampledStreamReaderSingleton(String bootstrapServers, String topicName) {
	...
	public static TwitterSampledStreamReaderSingleton getInstance() {
		...
		synchronized (TwitterSampledStreamReaderSingleton.class) {
			if (instance == null) {
				instance = new TwitterSampledStreamReaderSingleton(bootstrapServers, topicName);
			}
			return instance;
		}
	}
	...
	public static void main(String[] args) {
		new TwitterSampledStreamReaderSingleton(args[0], args[1]);
	}
